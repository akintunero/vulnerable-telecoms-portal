  ...
  return (
    <Layout>
      <div className="space-y-6">
        <h1 className="text-2xl font-semibold text-gray-900">Firewall</h1>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-lg font-medium mb-2">Active Rules</h3>
            <p className="text-3xl font-bold text-indigo-600">1,200</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-lg font-medium mb-2">Blocked Attempts</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-lg font-medium mb-4">Firewall Rules</h2>
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">FW-001</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Block Malicious IPs</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Deny</td>
                ...
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">FW-002</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Allow Internal Traffic</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Allow</td>
                  <td className="px-6 py-4 whitespace-nowrap"><span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Active</span></td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">2024-03-14</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">FW-003</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Block Outbound Traffic</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Deny</td>

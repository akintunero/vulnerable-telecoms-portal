...
export default function MaintenanceChanges() {
  return (
    <Layout>
      <div className="space-y-6">
        <h1 className="text-2xl font-semibold text-gray-900">Maintenance Changes</h1>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-lg font-medium mb-2">Pending Changes</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-lg font-medium mb-2">Failed Changes</h3>
            <p className="text-3xl font-bold text-red-600">2</p>
          </div>
        </div>
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-lg font-medium mb-4">Change List</h2>
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Change ID</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">CHG-001</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Update Firewall Rules</td>
                ...
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">CHG-002</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Upgrade Server</td>
                ...
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">CHG-003</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Patch Security</td>
